...
export const HERO_DEMO_SCENARIOS: readonly HeroDemoScenario[] = [
  {
    ...
    lines: [
      ...
      { kind: "codex", text: "pnpm add -D @jcode.labs/ragmir" },
      { kind: "output", textKey: "demo_out_added_dependency" },
      { kind: "codex", text: "pnpm exec rgr setup --agents codex" },
      ...
      {
        kind: "codex",
        text: 'pnpm exec rgr sources add "docs/**/*.md" "src/features/**/*.tsx"',
      },
      { kind: "output", textKey: "demo_aviation_out_sources" },
      { kind: "codex", text: "pnpm exec rgr doctor --fix" },
  ...
  },
  {
    ...
    terminalTitle: "zsh | ~/projects/payments-api",
    badge: "RFP",
    lines: [
      { kind: "shell", text: "cd ~/projects/payments-api" },
      { kind: "shell", text: "codex" },
      ...
      { kind: "codex", text: 'pnpm exec rgr sources add "docs/security/**/*.md" "docs/sla.md"' },
  ...
  },
  {
    ...
    terminalTitle: "zsh | ~/projects/checkout-web",
    badge: "Runbook",
    lines: [
      { kind: "shell", text: "cd ~/projects/checkout-web" },
      { kind: "shell", text: "codex" },
      ...
      {
        kind: "codex",
        text: 'pnpm exec rgr sources add "docs/runbooks/**/*.md" "docs/adr/**/*.md"',
      },
      ...
      { kind: "mcp", text: 'ragmir_search("checkout retry storm idempotency webhook")' },
      { kind: "citation", text: "[1] docs/runbooks/checkout-retries.md:22" },
      ...
      { kind: "change", text: "+ tests/e2e/checkout-retry.spec.ts" },
  ...
  },
  {
    ...
    lines: [
      ...
      { kind: "codex", text: "pnpm exec rgr setup --agents codex,claude" },
      ...
      {
        kind: "codex",
        text: 'pnpm exec rgr sources add "docs/contracts/**/*.md" "docs/tax/**/*.md"',
      },
  ...
  },
  {
    ...
    lines: [
      ...
      { kind: "codex", text: "pnpm exec rgr setup --agents codex,kimi" },
      ...
      {
        kind: "codex",
        text: 'pnpm exec rgr sources add "sources/**/*.md" "notes/**/*.md" "episodes/**/*.md"',
      },
  ...
  },
  {
    ...
    lines: [
      ...
      { kind: "codex", text: "pnpm exec rgr setup --agents opencode" },
      ...
      { kind: "codex", text: 'pnpm exec rgr sources add "docs/**/*.md" "evals/**/*.md"' },
