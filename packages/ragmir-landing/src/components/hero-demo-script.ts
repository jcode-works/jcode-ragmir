...
export const HERO_DEMO_SCENARIOS: readonly HeroDemoScenario[] = [
  ...
  },
  {
    ...
    terminalTitle: "zsh | ~/projects/client-portal",
    badge: "Confidential",
    lines: [
      { kind: "shell", text: "cd ~/projects/client-portal" },
      { kind: "shell", text: "codex" },
      ...
      {
        kind: "codex",
        text: "Use Ragmir to brief requirements, implementation plan, and E2E coverage.",
      },
      ...
      { kind: "change", text: "+ docs/implementation-brief.md" },
