import { Button } from "@jcode.labs/mimir-ui"
...
const GITHUB_URL = "https://github.com/jcode-works/jcode-mimir"

export function MimirLogo(): React.JSX.Element {
  return (
    <span className="logo-stack font-black text-2xl text-foreground leading-none tracking-tight md:text-3xl">
      <span className="logo-index-1">Mimir</span>
...
export function LandingNavbar({
  ...
  const navLinks = [
    ...
    { href: localizedDesktopUrl, label: t("nav_desktop") },
