...
export const PRODUCT_ID = "ragmir-desktop"
export const LICENSE_FORMAT = "RAGMIR1"
...
export async function readPrivateKey(values) {
  ...
  if (process.env.RAGMIR_LICENSE_PRIVATE_KEY_JWK) {
    return JSON.parse(process.env.RAGMIR_LICENSE_PRIVATE_KEY_JWK)
  }
  throw new Error("Provide --private-key <path> or RAGMIR_LICENSE_PRIVATE_KEY_JWK.")
}
