...
const tempDir = await mkdtemp(join(tmpdir(), "ragmir-native-checksums-smoke-"))
...
try {
  ...
  await writeFile(join(nestedDir, "ragmir"), "synthetic binary\n", "utf8")
  ...
  assertEqual(
    ...
    JSON.stringify(["app/ragmir", "ragmir_0.0.0_amd64.deb", "Ragmir_0.0.0.AppImage"]),
