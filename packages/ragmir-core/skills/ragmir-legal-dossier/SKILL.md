...
description: >-
  Prepare cited legal-dossier work products from a local Ragmir knowledge base. Use when the user asks
...
- Keep generated work under `.ragmir/reports/` unless the user explicitly asks for a sanitized
  tracked artifact.
