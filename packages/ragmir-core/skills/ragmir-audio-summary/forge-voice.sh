#!/usr/bin/env bash
# Render a Ragmir audio-summary text file to MP3. The text is a throwaway intermediate written
# outside the repository by the skill. The final audio should normally be written under .ragmir/audio.
#
