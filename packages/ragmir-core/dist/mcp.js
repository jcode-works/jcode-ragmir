...
export async function serveMcp(cwd = resolveMcpProjectRoot()) {
    ...
    server.registerTool("ragmir_status", {
        title: "Ragmir Status",
    ...
    server.registerTool("ragmir_search", {
        title: "Ragmir Search",
    ...
    server.registerTool("ragmir_ask", {
        title: "Ragmir Ask",
    ...
    server.registerTool("ragmir_research", {
    ...
    server.registerTool("ragmir_security_audit", {
    ...
    server.registerTool("ragmir_usage_report", {
